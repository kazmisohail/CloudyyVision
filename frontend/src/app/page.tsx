...
export default function Home() {
  ...
  const [mitigatedImage, setMitigatedImage] = useState<string | null>(null);
  const [solarHeatmap, setSolarHeatmap] = useState<string | null>(null);
  ...
  const handleAnalyze = async (file: File) => {
    ...
    setMitigatedImage(null);
    setSolarHeatmap(null);
    setCurrentFile(file);
    ...
    try {
      ...
      setSolarHeatmap(data.solar_heatmap);

      // Update original image with the preview generated by backend (supports .npy)
  ...
  const handleMitigate = async () => {
    ...
    try {
      ...
      const data = await response.json();
      setMitigatedImage(data.mitigated_image);

    } catch (error) {
      console.error("Error mitigating shadows:", error);
      alert("Failed to mitigate shadows. Please try again.");
    } finally {
  ...
  return (
    <main className="min-h-screen bg-[#0f172a] overflow-x-hidden relative">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <option value="v3">Attention U-Net V3</option>
      ...
      {/* Chat Interface */}
      <ChatInterface metrics={analysisResult ? analysisResult.percentages : null} />
    </main>
  );
}
